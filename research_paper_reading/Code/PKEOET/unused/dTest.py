...
if __name__ == '__main__':
    ...
    logger = Logger('/home/seed/Documents/ResearchPaper/PKEOET/output/log_d.txt', title="PKEOET")
    ...
    cursor = 0
    dTest_time = 0
    with open('/home/seed/Documents/ResearchPaper/PKEOET/ciphertexts/v.txt', 'r') as f:
